...
echo "<h1> Hi, {$_SESSION['firstName']}. Ready to do your homework?</h1>";
...
LIMIT 5";
$dbr = mysqli_query($dbc, $dbq) or die("Couldn't check your progress. Please check with your teacher about this.");
...
if($dbr) {# if the query ran ok
	...
	#output headers:
	?><table><?php echo "<h2>Here are today's words:</h2>";
						?><tr><?php 	
							for($i=0; $i<$headers; $i++){
